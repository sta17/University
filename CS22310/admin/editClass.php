<?php
$page_title = "NCF Edit Class";
$page_header = "North Ceredigion Fitness(NCF) Edit Class Page";
$page_description = "North Ceredigion Fitness Edit Class webpage";
?>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body>
        ...
        <main>
            <div id="container">
                ...
                <div id="main">
                    <section>
                        <h2>To Edit a Class</h2>
                        <p>
                            To edit a class, please pick a class from the list below, once one is picked,
                            ...
                            There are two date fields, one for the start date and one for the end date of the period
                        ...
                        <form>
                            <br>Please enter the name of the class.
                            Classmame: <input type="text" name="classname" size="50"placeholder="Classname here"/><br>
                            <br>Please enter the time of the day the class is supposed to be on.<br>
                            Time:
                            ...
                            <br>
                            Start Date: <input type="date" placeholder="YYYY-MM-DD" name="startperiod"><br>
                            End Date: <input type="date" placeholder="YYYY-MM-DD" name="endperiod">
                            <br>
                            <br>Instructers only Notes:<br>
