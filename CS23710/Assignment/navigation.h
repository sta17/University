 ...
 * The two members are double representing the latitude and longitude
...
/*The great_circle function takes two struct parameter
 ...
 * between the location as a double.
 */

double great_circle(location location_1, location locatopn_2);
