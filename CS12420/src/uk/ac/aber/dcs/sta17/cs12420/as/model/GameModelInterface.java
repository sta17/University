...
/**
 * This interface describes the behaviour of a hangman type of game To be used
 * in CS124 individual assignment
 */
public interface GameModelInterface {
	...
	/**
	 * this method sees if the letter is in the words if it is it updates what
	 * the user can see (visible) if not it removes a guess
	 * 
	 * @param letter
	 *            the letter to try
	...
	/**
	 * this method sees if the word guess is correct if it is it updates what
	 * the user can see (visible) if not it removes 5 guesses
	 * 
	 * @param guess
	 *            the word to guess
	 * @return whether there is winner
